# Tractfinder is Copyright (c) 2023-2026 Fiona Young, and (c) 2026 Tractfinder
# contributors. The software is distributed "as is", without any warranty, for
# non-commercial use only. Any commercial use, including incorporation into a
# product for sale, or use of the software to provide paid services, is not
# permitted without a commercial license. For licensing enquiries please
# contact UCL Business Ltd (https://www.uclb.com).
# 
# Tractfinder may include redistributed source files from MRtrix3
# (https://www.mrtrix.org/), which are subject to separate licensing terms.
